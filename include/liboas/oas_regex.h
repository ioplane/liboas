 ...
 *
 * Provides a vtable-based regex backend. The default implementation uses
 * vendored QuickJS libregexp for 100% ECMA-262 compliance, which is
 * required by OpenAPI 3.x pattern validation.
 */
...
/**
 * @brief Create a libregexp (QuickJS) regex backend.
 *
 * Uses vendored QuickJS libregexp for 100% ECMA-262 compliance.
 * Patterns are compiled with LRE_FLAG_UNICODE for full Unicode support.
 *
