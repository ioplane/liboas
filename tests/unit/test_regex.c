...
void setUp(void)
{
    backend = oas_regex_libregexp_create();
}
...
void test_regex_libregexp_create(void)
{
...
{
    oas_regex_backend_t *b = oas_regex_libregexp_create();
    TEST_ASSERT_NOT_NULL(b);
    b->destroy(b);
    /* free_pattern with nullptr should not crash */
...
{
    UNITY_BEGIN();
    RUN_TEST(test_regex_libregexp_create);
