...
static const struct {
    ...
    {"date", oas_format_date},
    {"date-time", oas_format_date_time},
    {"time", oas_format_time},
    {"email", oas_format_email},
    {"uri", oas_format_uri},
    {"uri-reference", oas_format_uri_reference},
    {"uuid", oas_format_uuid},
    {"ipv4", oas_format_ipv4},
    {"ipv6", oas_format_ipv6},
    {"hostname", oas_format_hostname},
    {"byte", oas_format_byte},
    {"int32", oas_format_int32},
